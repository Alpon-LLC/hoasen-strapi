...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    title: Schema.Attribute.String &
      ...
      Schema.Attribute.DefaultTo<'Why you should never hire a cheap Malaysian engineering firm to build you a platform'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiDesignProjectDesignProject
  ...
  attributes: {
    ...
    hero_logo: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::project.project'
    >;
    logo_icon: Schema.Attribute.Media<'images'> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiTeamMemberTeamMember extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    contact_links: Schema.Attribute.Component<'shared.contact-link', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    framework_and_tool: Schema.Attribute.Component<
    ...
    get_to_know: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    why_work_with_them: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiTeamPageTeamPage extends Struct.CollectionTypeSchema {
